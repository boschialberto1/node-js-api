...
$result = $ws->send(json_encode(array("winners"=> array('ms343423g' => 'mess34565g46',
    'msg2' => 'mess34565g4srdf',
    'msg3' => 'mess34fddsfdsglh',
    'msg4' => 'messdsafasdfdsfah',
    'msg5' => 'sdfsdafsd444hglh'))));
$ws->close();
	...
	public function __construct($params)
	{
		...
		if(isset($_SERVER['REMOTE_ADDR']))
			$local = "http://".$_SERVER['REMOTE_ADDR'];
                $hash = hash_hmac("sha256", $local, 'wsConnectionSecurev1');
